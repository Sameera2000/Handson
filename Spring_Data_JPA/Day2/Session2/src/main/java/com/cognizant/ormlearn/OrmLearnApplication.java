...
public class OrmLearnApplication {
	...
	public static void testGetAllPermanentEmployees() {
		...
		LOGGER.info("Get All Permanent Employees start");
        List<Employee> employees = employeeService.getAllPermanentEmployees();
        LOGGER.debug("Permanent Employees:{}", employees);
        employees.forEach(e -> LOGGER.debug("Skills:{}", e.getSkillList()));
        LOGGER.info("Get All Permanent Employees end");
	...
	public static void testgetAverageSalary() {
        ...
        double employees = employeeService.getAverageSalary(2);
        LOGGER.debug("Average salary of Employees:{}", employees);
        
        LOGGER.info("Get Average salary end");
	...
	public static void testgetAllEmployeesNative() {
        ...
        LOGGER.debug("All native Employees:{}", employees);
        
        LOGGER.info("Get all employees native end");
